...
public struct DYLineDataSet: Identifiable {
    ...
    public init(id: UUID = UUID(), dataPoints: [DYDataPoint], selectedIndex: Binding<Int>, pointView: ((DYDataPoint)-> AnyView)? = nil, labelView: ((DYDataPoint)->AnyView?)? = nil, colorPerLineSegment: ((DYDataPoint)->Color)? = nil, selectorView: AnyView? = nil, settings: DYLineSettings = DYLineSettings()) {
        self.id = id
