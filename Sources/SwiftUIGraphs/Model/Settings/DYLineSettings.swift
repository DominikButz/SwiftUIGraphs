...
public struct DYLineSettings {
    ...
    public init(lineColor: Color = .primary, lineStrokeStyle: StrokeStyle = StrokeStyle(lineWidth: 2, lineCap: .round, lineJoin: .round, miterLimit: 80, dash: [], dashPhase: 0), lineDropShadow: Shadow? = nil, showAppearAnimation: Bool = true, lineAnimationDuration: TimeInterval = 1.4, interpolationType: InterpolationType = .quadCurve, allowUserInteraction: Bool = true, lineAreaGradient: LinearGradient? = nil, lineAreaGradientDropShadow: Shadow? = nil, xValueSelectedDataPointLineColor:Color? = nil,   xValueSelectedDataPointLineStrokeStyle: StrokeStyle = StrokeStyle(lineWidth: 2, dash: [3]),  yValueSelectedDataPointLineColor: Color? = nil, yValueSelectedDataPointLineStrokeStyle: StrokeStyle = StrokeStyle(lineWidth: 2, dash: [3])) {
