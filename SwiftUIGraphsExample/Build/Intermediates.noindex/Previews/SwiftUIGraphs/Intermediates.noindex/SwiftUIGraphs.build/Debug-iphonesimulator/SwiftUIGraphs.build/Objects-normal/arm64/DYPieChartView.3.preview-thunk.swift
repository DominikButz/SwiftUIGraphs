...
extension DYPieChartView_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        __designTimeSelection(DYPieChartView(data: __designTimeSelection(data, "#40639.[3].[0].property.[0].[1].arg[0].value"), selectedId: .constant(data.first!.id), valueConverter: { (value) -> String in
        ...
        }, settings: __designTimeSelection(DYPieChartSettings(innerCircleFraction: __designTimeFloat("#40639.[3].[0].property.[0].[1].arg[3].value.arg[0].value", fallback: 0.3)), "#40639.[3].[0].property.[0].[1].arg[3].value")).padding(), "#40639.[3].[0].property.[0].[1]")
    #sourceLocation()
    }
}
...
extension DYPieChartView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(__designTimeSelection(GeometryReader {proxy in
            ...
            }, "#40639.[1].[6].property.[0].[0].arg[0].value.[0]")
